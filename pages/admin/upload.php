...
$sql = "SELECT profile_image_path FROM doctor WHERE id = ?";
...
if (move_uploaded_file($_FILES["profile_photo"]["tmp_name"], $targetFilePath)) {
    $sqlUpdate = "UPDATE doctor SET profile_image_path = ? WHERE id = ?";
    $stmtUpdate = $con->prepare($sqlUpdate);
    $stmtUpdate->bind_param("si", $targetFilePath, $doctorId);
    $stmtUpdate->execute();
