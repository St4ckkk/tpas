...
$res = mysqli_query($con, "SELECT * FROM patient WHERE philhealthId=" . $_SESSION['patientSession']);
...
if (isset($_POST['submit'])) {
	...
	$res = mysqli_query($con, "UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName', patientMaritialStatus='$patientMaritialStatus', patientDOB='$patientDOB', patientGender='$patientGender', patientAddress='$patientAddress', patientPhone=$patientPhone, patientEmail='$patientEmail' WHERE philhealthId=" . $_SESSION['patientSession']);
				...
				<div class="row">
					<div class="col-md-3 col-sm-3">
						...
						<div class="user-wrapper">
							<img src="assets/img/patient.png" class="img-responsive" height="200px" />
