...
if (isset($_POST['prescription'])) {
    ...
    // Insert data into tbprescription table
    $insertPrescriptionQuery = "INSERT INTO tbprescription (philhealthId, medication, icDoctor, dosage, comment, instructions)
...
?>
        <script type="text/javascript">
            alert('TB Prescription Submitted successfully.');
        </script>
    <?php
    } else {
    ?>
        <script type="text/javascript">
            alert('TB Prescription submission failed. Please try again.');
        </script>
<?php
    }
}
